...
!(function(t, e) {
            ...
            Ce(
                (function(t) {
                    var e,
                        ...
                        l = -n.scrollTop;
                    return (
                        'rtl' === Zt(s || i).direction && (a += Vt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                    );
                })(ee(t))
            );
    }
                    ...
                    r = xt.reduce(function(t, i) {
                        return (
                            (t[i] = (function(t, e, i) {
                                ...
                                return (
                                    (r = r || 0),
                                    (a = (a || 0) * s), [_t, gt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                                );
                            })(i, e.rects, o)),
                            t
                        );
        ...
        je = {
            ...
            fn: function(t) {
                var e = t.state,
                    ...
                    O =
                    'number' == typeof C ? { mainAxis: C, altAxis: C } :
    ...
    function Fe(t, e, i) {
        ...
        return (
            ...
            (('body' !== Ht(e) || Ae(a)) &&
                (c =
                    (n = e) !== $t(n) && Bt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } :
                    ye(n)),
                Bt(e) ? (((h = Ut(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = we(a))), { x: l.left + c.scrollLeft - h.x, y: l.top + c.scrollTop - h.y, width: l.width, height: l.height }
        );
    }
